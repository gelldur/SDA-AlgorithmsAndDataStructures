...
public class HanoiTowerTest {
	...
	public void testInitialState() {
		assertArrayEquals(new Integer[] { 1, 2, 3, 4 }, _hanoi.getStateOfPile('A').toArray());
	...
	public void test() {
		assertArrayEquals(new Integer[] { 1, 2, 3, 4 }, _hanoi.getStateOfPile('A').toArray());
		_hanoi.makeStep();
		assertArrayEquals(new Integer[] { 2, 3, 4 }, _hanoi.getStateOfPile('A').toArray());
		assertArrayEquals(new Integer[] { 1 }, _hanoi.getStateOfPile('B').toArray());
		_hanoi.makeStep();
		assertArrayEquals(new Integer[] { 3, 4 }, _hanoi.getStateOfPile('A').toArray());
		assertArrayEquals(new Integer[] { 1 }, _hanoi.getStateOfPile('B').toArray());
		assertArrayEquals(new Integer[] { 2 }, _hanoi.getStateOfPile('B').toArray());
		while(_hanoi.makeStep()) {
		}
		
		assertArrayEquals(new Integer[] {}, _hanoi.getStateOfPile('A').toArray());
		assertArrayEquals(new Integer[] {}, _hanoi.getStateOfPile('B').toArray());
		assertArrayEquals(new Integer[] { 1, 2, 3, 4 }, _hanoi.getStateOfPile('C').toArray());
	}
